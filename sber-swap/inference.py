...
def init_models(args):
    ...
    app.prepare(ctx_id=0 if use_cuda else -1, det_thresh=0.6, det_size=(640,640))
    ...
    handler = Handler('./coordinate_reg/model/2d106det', 0, ctx_id=0 if use_cuda else -1, det_size=640)
